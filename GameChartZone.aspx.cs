...
public partial class GameChartZone : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (IsPostBack == false)
        {
            try
            {
                ...
                SS = "Select '" + NoofDays.ToString() + "%'  as W,*,convert(varchar,RDate,107) as DT from DeclareResult where GameId =" + Id + " order by RDate";
                Dt = new clsDataAccess().GetDataTable(SS);
